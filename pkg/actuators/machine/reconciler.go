...
func (r *Reconciler) setProviderID(instance *models.PVMInstance) error {
	...
	if r.providerSpec.ServiceInstanceID != "" {
		serviceInstanceID = r.providerSpec.ServiceInstanceID
	} else if r.providerSpec.ServiceInstance.ID != nil {
		serviceInstanceID = *r.providerSpec.ServiceInstance.ID
	} else if providerStatus.ServiceInstanceID != nil {
